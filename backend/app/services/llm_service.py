...
class ModelConfig:
    ...
    MODELS = {
        "deepseek-ai/DeepSeek-V4-Pro":{
            ...
            "max_tokens": 4096,
            "temperature": 0.7,
            "best_for": "wen/Qwen2.5-Coder-7B-InstructComplex reasoning, analysis, and summarization",
            "size": "862B"
        },
...
class LLMService:
    ...
    def get_model_for_capability(self, capability: ModelCapability) -> str:
        ...
        default_models = {
            ...
            ModelCapability.QUESTION_ANSWERING: "Qwen/Qwen2.5-Coder-7B-Instruct",
            ModelCapability.REASONING: "deepseek-ai/DeepSeek-V4-Pro",
        }
        
        model = default_models.get(capability, "Qwen/Qwen2.5-Coder-7B-Instruct")
